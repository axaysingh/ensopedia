  ...
  return (
    ...
    >
      ...
      >
        <div className="svg-parent is-yellow">
          <div className="stats is-yellow">
            <h5 className={`${!moving ? 'title' : ''}`} style={{color:'#ffc10799'}}>Confirmed</h5>
            <h5 className={`${moving ? 'title' : ''}`} style={{color:'#ffc10799'}}>
              {isYesterday
        ...
        <div className="svg-parent is-cherry">
          <div className="stats is-cherry">
            <h5 className={`${!moving ? 'title' : ''}`} style={{color:'#ff073a99'}}>Deceased</h5>
            <h5 className={`${moving ? 'title' : ''}`} style={{color:'#ff073a99'}}>
              {isYesterday
                ? `${datapoint['date']} Yesterday`
                : datapoint['date']}
            </h5>
      ...
      >
        <div className="svg-parent is-yellow">
          <div className="stats">
            <h5 className={`${!moving ? 'title' : ''}`} style={{color:'#ffc107'}}>Confirmed</h5>
            <h5 className={`${moving ? 'title' : ''}`} style={{color:'#ffc107'}}>
              {isYesterday
                ? `${datapoint['date']} Yesterday`
                : datapoint['date']}
            </h5>
            <div className="stats-bottom">
              <h2 style={{color:'#ffc107'}}>{datapoint['dailyconfirmed']}</h2>
